...
from . import views
from .views import DeleteCommentView, UpdateCommentView
...
urlpatterns = [
    ...
    path("cart/add/<int:game_id>", views.cart_add_game, name="cart-add-game"),
    path(
    ...
    path(
        "comments/edit/<int:pk>/", UpdateCommentView.as_view(), name="comment-edit"
    ),  # views.comment_edit
    path(
        "comments/delete/<int:pk>/", DeleteCommentView.as_view(), name="comment-delete"
